...
import { TicketStatus, Priority, Category } from "@/lib/types";

export default function ComplaintDetail() {
  const { id } = useParams<{ id: string }>();
  const { complaints, currentUser, messages, addMessage, updateComplaintStatus, updateComplaintPriority, updateComplaintCategory } = useAppStore();
              ...
              <div className="flex flex-wrap gap-3 pt-2 border-t">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onValueChange={(v) => {
                      updateComplaintCategory(complaint.id, v as Category);
